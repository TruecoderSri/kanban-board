    ...
    <Root>
      <Container>
        <Header>
          ...
          <HeaderActions>
            {/* <IssueCount>{`${item?.issues.length} issue${
            ...
            <div ref={provided.innerRef} {...provided.droppableProps}>
              {item.issues.map((issue, index) => (
                <Issue
                  ...
                  onMoveToLeftColumn={() =>
                    onMoveIssueToLeftColumn(item, issue)
                  }
                  onMoveToRightColumn={() =>
                    onMoveIssueToRightColumn(item, issue)
                  }
                  index={index}
                />
              ))}
        ...
        <IssueFormModal
          ...
          onSubmit={(id, title, description) => {
            id
              ? handleOnIssueEdit(id, title, description)
              : handleOnIssueAdd(title, description);
          }}
          onCancel={() => {
            setIssueModalVisible(false);
